...
class MetersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create meter" do
    assert_difference('Meter.count') do
      post meters_url, params: { meter: { first_name: @meter.first_name, last_name: @meter.last_name, meters: @meter.meters, month: @meter.month } }
    end
  ...
  test "should update meter" do
    patch meter_url(@meter), params: { meter: { first_name: @meter.first_name, last_name: @meter.last_name, meters: @meter.meters, month: @meter.month } }
